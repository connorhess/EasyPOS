...
def TableNumberGenerate(Title,tableNO):
    ...
    def F9():
        ...
        F101 = Frame(Page4, width=92, height=130, bd=8, bg="grey", relief="raise")
        F101.place(x=3,y=90)


        Button(Page4, text="9", width=2, bg="blue", fg="white", command=K9, bd=2).place(x=11,y=100)
        Button(Page4, text="8", width=2, bg="blue", fg="white", command=K8, bd=2).place(x=36,y=100)
        Button(Page4, text="7", width=2, bg="blue", fg="white", command=K7, bd=2).place(x=61,y=100)
        Button(Page4, text="6", width=2, bg="blue", fg="white", command=K6, bd=2).place(x=11,y=126)
        Button(Page4, text="5", width=2, bg="blue", fg="white", command=K5, bd=2).place(x=36,y=126)
        Button(Page4, text="4", width=2, bg="blue", fg="white", command=K4, bd=2).place(x=61,y=126)
        Button(Page4, text="3", width=2, bg="blue", fg="white", command=K3, bd=2).place(x=11,y=152)
        Button(Page4, text="2", width=2, bg="blue", fg="white", command=K2, bd=2).place(x=36,y=152)
        Button(Page4, text="1", width=2, bg="blue", fg="white", command=K1, bd=2).place(x=61,y=152)
        Button(Page4, text="0", width=2, bg="blue", fg="white", command=K0, bd=2).place(x=36,y=179)
        Button(Page4, text=".", width=2, bg="blue", fg="white", command=K, bd=2).place(x=11,y=179)
        Button(Page4, text="C", width=2, bg="blue", fg="white", command=K10, bd=2).place(x=61,y=179)
